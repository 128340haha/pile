$(document).ready(function() {
	...
	$(".mws-datepicker-btn").datepicker({showOtherMonths:true, showButtonPanel:true, dateFormat:'yy-mm-dd'});

	$(".mws-datepicker-btn-limit").datepicker({showOtherMonths:true, showButtonPanel:true, maxDate:0, dateFormat:'yy-mm-dd'});
